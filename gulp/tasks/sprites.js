...
gulp.task('icons', ['createSprite', 'copySpriteCss', 'copySpriteGraphic']); // dakle prvo ce da se izvrsava createSprite, i onda ce ovaj copySpriteCss da ceka sve dok se ovaj createSprite ne izvrsi